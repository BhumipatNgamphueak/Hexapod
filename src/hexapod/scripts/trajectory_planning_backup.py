#!/usr/bin/env python3
"""
Trajectory Generator Node - Trapezoidal Velocity Profile (ONE PER LEG)
INPUT: /hexapod/leg_X/end_effector_setpoint (PointStamped - discrete position)
INPUT: /hexapod/leg_X/phase_info (Float64MultiArray - phase type)
...
class TrajectoryGenerator(Node):
    ...
    def setpoint_callback(self, msg):
        ...
        # Start new trapezoidal trajectory
